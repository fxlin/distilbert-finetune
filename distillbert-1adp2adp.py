...
for epoch in range(num_epochs):
    ...
    np.save("1adp2adp/{}_cls_step_SkipRatio_ValAcc_ClsAcc.npy".format(config_num_NB), np.array([skip_ratio, val_acc, classifier_acc[-1]]))
    np.save("1adp2adp/{}_cls_step_ClsAcc_all.npy".format(config_num_NB), np.array(classifier_acc))
    np.save("1adp2adp/{}_cls_step_ThreHis.npy".format(config_num_NB), np.array(loss_threshold_history))
